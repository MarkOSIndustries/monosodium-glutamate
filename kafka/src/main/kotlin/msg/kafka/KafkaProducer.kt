...
open class KafkaProducer<K, V, SK : Serializer<K>, SV : Serializer<V>>(brokers: Collection<Broker>, keySerializer: KClass<SK>, valueSerializer: KClass<SV>, clientId: String, vararg config: Pair<String, Any>) : KafkaProducer<K, V>(
  mapOf(
