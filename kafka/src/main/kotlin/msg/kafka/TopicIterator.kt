...
class TopicIterator<K, V>(
  private val consumer: Consumer<K, V>,
  private val topic: String,
  startOffsetInclusiveSpec: OffsetSpec,
  endOffsetExclusiveSpec: OffsetSpec,
  private val interrupted: CompletableFuture<Unit> = CompletableFuture(),
