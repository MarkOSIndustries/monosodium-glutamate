...
class TimestampAndPartitionsOffsetSpec(
  private val timestampEpochMs: Long,
  private val configuredPartitions: Collection<TopicPartition>,
) : TimeBasedOffsetSpec {
  ...
  override fun <K, V> getOffsetsWithTimestamps(
    consumer: Consumer<K, V>,
    topicPartitions: Collection<TopicPartition>,
